...
CompetitionNotFound = message("问卷不存在", "您要找的问卷不存在")
BankInfoNotFound = message("题库不存在", "当前问卷未配置题库")
QuestionLogNotFound = message("问卷记录不存在", "您的答题记录不存在")
CompetitionHasEnded = message("问卷已经结束", "您要参与的问卷已经结束")
CompetitionNotStarted = message("问卷尚未开始", "您要参加的问卷还没开始")
