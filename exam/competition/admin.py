...
class ChoiceInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ('bank_id', 'question', 'answer', 'item1', 'item2', 'item3', 'item4', 'item5' ,'source', 'status', 'created_at', 'updated_at')
    list_filter = ('bank_id', 'status')
    search_fields = ('bank_id', 'question', 'answer', 'item1', 'item2', 'item3', 'item4','item5')
