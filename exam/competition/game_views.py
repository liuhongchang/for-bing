...
def get_questions(request):
    ...
    获取题目信息接口
    :param request: 请求对象
    :return: 返回json数据: user_info: 用户信息;kind_info: 问卷信息;qa_id: 问卷答题记录;questions: 问卷随机后的题目;
    """
...
def submit_answer(request):
    ...
    提交答案接口
    :param request: 请求对象
    :return: 返回json数据: user_info: 用户信息; qa_id: 问卷答题记录标识; kind_id: 问卷唯一标识
    """
    ...
    qa_info.save()
    kind_info.total_partin_num += 1  # 保存问卷数据
    kind_info.save()  # 问卷答题次数
...
def userinfo_entry(request):
    ...
    用户表单提交接口
    :param request: 请求对象
    :return: 返回json数据: user_info: 用户信息; kind_info: 问卷信息
    """
